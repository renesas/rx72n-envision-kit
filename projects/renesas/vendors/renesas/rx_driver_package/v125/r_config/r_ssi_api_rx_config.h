...
*******************************************************************************/
/******************************************************************************
* File Name    : r_ssi_api_rx_config.h
* Version      : 2.00
...
/******************************************************************************
    ...
    NOTE: This is a configuration which must be set wether
            in case of "SSI_STANDARD_CONFIG" or "SSI_USER_UNIQUE_CONFIG". 
*******************************************************************************/
#define SSIE_CH0_IO_MODE    (1u)    /* Ch0 Transmit / Receive mode selection */
#define SSIE_CH1_IO_MODE    (2u)    /* Ch1 Transmit / Receive mode selection */
...
/******************************************************************************
    ...
    ----------------------------------
      ...
      32bit                 (32u)
*******************************************************************************/
#define SSIE_CH0_DATA_WIDTH   (24u)          /* Ch0 PCM data width */
#define SSIE_CH1_DATA_WIDTH   (24u)          /* Ch1 PCM data width */
...
/******************************************************************************
    ...
    NOTE: Set the Master Clock to the integral multiple of the Bit Clock.
*******************************************************************************/
#define SSIE_MCLK         (512u)         /* Master Clock */
