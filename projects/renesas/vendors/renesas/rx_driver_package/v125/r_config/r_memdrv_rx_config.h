...
#define MEMDRV_CFG_DEV0_MODE_DRVR         (MEMDRV_DRVR_RX_FIT_QSPI_SMSTR)
...
#define MEMDRV_CFG_DEV0_BR                (30000000)
                                        /* Device 0 Transfer rate for command transmission.     */
#define MEMDRV_CFG_DEV0_BR_WRITE_DATA     (30000000)
                                        /* Device 0 Transfer rate for data transmission.        */
#define MEMDRV_CFG_DEV0_BR_READ_DATA      (30000000)
