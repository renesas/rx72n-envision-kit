...
* Version      : 1.14
* Device       : RX
* Abstract     : Specifics file dedicated to RX72N for QSPI single master drive
...
/* ==== QSPI channel 0. ==== */
    ...
    #elif (('H' == R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT) || ('h' == R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT_SFR     H
    ...
    #elif (('K' == R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT) || ('k' == R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT_SFR     K
    #elif (('L' == R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT) || ('l' == R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT_SFR     L
    #elif (('M' == R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT) || ('m' == R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT_SFR     M
    #elif (('N' == R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT) || ('n' == R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT_SFR     N
    #elif (('Q' == R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT) || ('q' == R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QSPCLK_PORT_SFR     Q
    #endif
    ...
    #elif (('H' == R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT) || ('h' == R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT_SFR     H
    #elif (('J' == R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT) || ('j' == R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT_SFR     J
    #elif (('K' == R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT) || ('k' == R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT_SFR     K
    #elif (('L' == R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT) || ('l' == R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT_SFR     L
    #elif (('M' == R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT) || ('m' == R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT_SFR     M
    #elif (('N' == R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT) || ('n' == R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT_SFR     N
    #elif (('Q' == R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT) || ('q' == R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO0_PORT_SFR     Q
    #endif
    ...
    #elif (('H' == R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT) || ('h' == R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT_SFR     G
    #elif (('J' == R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT) || ('j' == R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT_SFR     J
    #elif (('K' == R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT) || ('k' == R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT_SFR     K
    #elif (('L' == R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT) || ('l' == R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT_SFR     L
    #elif (('M' == R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT) || ('m' == R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT_SFR     M
    #elif (('N' == R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT) || ('n' == R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT_SFR     N
    #elif (('Q' == R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT) || ('q' == R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO1_PORT_SFR     Q
    #endif
    ...
    #elif (('H' == R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT) || ('h' == R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT_SFR     H
    #elif (('J' == R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT) || ('j' == R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT_SFR     J
    #elif (('K' == R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT) || ('k' == R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT_SFR     K
    #elif (('L' == R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT) || ('l' == R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT_SFR     L
    #elif (('M' == R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT) || ('m' == R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT_SFR     M
    #elif (('N' == R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT) || ('n' == R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT_SFR     N
    #elif (('Q' == R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT) || ('q' == R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO2_PORT_SFR     Q
    #endif
    ...
    #elif (('H' == R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT) || ('h' == R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT_SFR     H
    #elif (('J' == R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT) || ('j' == R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT_SFR     J
    #elif (('K' == R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT) || ('k' == R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT_SFR     K
    #elif (('L' == R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT) || ('l' == R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT_SFR     L
    #elif (('M' == R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT) || ('m' == R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT_SFR     M
    #elif (('N' == R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT) || ('n' == R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT_SFR     N
    #elif (('Q' == R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT) || ('q' == R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT))
        #define R_QSPI_SMSTR_CFG_QSPI_QIO3_PORT_SFR     Q
    #endif
