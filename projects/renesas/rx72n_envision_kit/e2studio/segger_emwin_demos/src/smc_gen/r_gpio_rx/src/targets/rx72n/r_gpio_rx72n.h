...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_gpio_rx72m.h
* Description  : Specifics for the r_gpio_rx driver for the RX72M.
***********************************************************************************************************************/
/***********************************************************************************************************************
...
#define GPIO_INFO_NUM_PORTS                 (24)
    ...
    #define GPIO_INFO_NUM_PINS              (137)
#else
    #error "r_gpio_rx does not have information about this RX72M package. Please update r_gpio_rx72N.h"
#endif
...
#define GPIO_DSCR_IS_SUPPORTED    /* High-drive output is supported for the RX72M */
#define GPIO_DSCR2_IS_SUPPORTED   /* Large current output, high-drive output is supported for the RX72M */
...
#elif (BSP_PACKAGE_PINS == 176 || BSP_PACKAGE_PINS == 144)
/* This enumerator has each available GPIO port on this MCU. This list will change depending on the MCU chosen. */
typedef enum
{
    GPIO_PORT_0 = 0x0000,
