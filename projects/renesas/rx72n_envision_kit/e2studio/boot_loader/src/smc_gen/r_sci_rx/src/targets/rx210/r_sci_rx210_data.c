...
/* rom info */
const sci_ch_rom_t  ch10_rom = {(volatile struct st_sci12 R_BSP_EVENACCESS_SFR *)&SCI10,
...
/* rom info */
const sci_ch_rom_t  ch11_rom = {(volatile struct st_sci12 R_BSP_EVENACCESS_SFR *)&SCI11,
