...
void sdcard_task( void * pvParameters )
{
    ...
    while(1)
    {
        ...
        if(previous_sdc_sd_card_detection != sdc_sd_card_detection)
        {
            ...
            {
//                display_update_sd_stat(task_info->hWin_firmware_update_via_sd_card, 0);	/* 0 means attach */
            ...
            {
//                display_update_sd_stat(task_info->hWin_firmware_update_via_sd_card, 1);	/* 1 means detach */
                previous_sdc_sd_card_detection = sdc_sd_card_detection;
                if(SDC_SD_SUCCESS != sdc_sd_card_detection)
                {
