...
void sdcard_task( void * pvParameters )
{
    ...
    static sdc_sd_status_t sdc_sd_card_detection = SDC_SD_SUCCESS;
    static sdc_sd_status_t previous_sdc_sd_card_detection = SDC_SD_SUCCESS;
    ...
    sdc_sd_status = R_SDC_SD_CdInt(g_sdc_sd_card_no, SDC_SD_CD_INT_ENABLE, r_sdc_sd_cd_callback);
...
/*******************************************************************************
* Declaration  : sdc_sd_status_t r_sdc_sd_cd_callback(int32_t cd)
* Function Name: r_sdc_sd_cd_callback
* Description  : SD memory card detection callback
* Arguments    : Error code
* Return Value : none
*******************************************************************************/
sdc_sd_status_t r_sdc_sd_cd_callback(int32_t cd)
{
    R_SDC_SD_CdInt(g_sdc_sd_card_no, SDC_SD_CD_INT_DISABLE, 0);
