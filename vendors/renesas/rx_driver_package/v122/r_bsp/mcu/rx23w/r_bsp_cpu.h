...
typedef enum
{
    /* PRC0
       ...
       MOSCCR, SOSCCR, LOCOCR, ILOCOCR, HOCOCR, OSTDCR, OSTDSR, CKOCR, UPLLCR, UPLLCR2, HOCOCR2, LOCOTRR, ILOCOTRR,
       HOCOTRR0, HOCOTRR3 */
    ...
    /* PRC1
       Enables writing to the registers related to operating modes, low power consumption, the clock generation circuit,
        and software reset: SYSCR1, SBYCR, MSTPCRA, MSTPCRB, MSTPCRC, MSTPCRD, OPCCR, RSTCKCR, SOPCCR,
       MOFCR, MOSCWTCR, SWRR */
    BSP_REG_PROTECT_LPC_CGC_SWR,

    /* PRC2
       Enables writing to the registers related to low power timer: LPTCR1, LPTCR2, LPTCR3, LPTPRD, LPCMR0,
       LPWUCR */
    BSP_REG_PROTECT_LPT,

    /* PRC3
       Enables writing to the registers related to the LVD: LVCMPCR, LVDLVLR, LVD1CR0, LVD1CR1, LVD1SR,
