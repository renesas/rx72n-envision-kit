...
/* This macro means that this MCU is part of the RX24x collection of MCUs (i.e. RX24T). */
#define BSP_MCU_RX24_ALL            (1)

/* MCU Group name. */
#if BSP_CFG_MCU_PART_GROUP == 0x0
    #define BSP_MCU_RX24T           (1)
#else
...
#if   BSP_CFG_MCU_PART_MEMORY_SIZE == 0xE
...
/* Clock source select (CKSEL).
   ...
   3 = Sub-Clock Oscillator                     (N/A RX24T have not Sub-Clock)
   4 = PLL Circuit
*/ 
...
#define BSP_MCU_MEMWAIT_FREQ_THRESHOLD        (64000000)
