...
#define	EDMAC	(*(volatile struct st_edmac   __sfr __evenaccess *)0xC0000)
#define	ETHERC	(*(volatile struct st_etherc  __sfr __evenaccess *)0xC0100)
...
#define	RIIC3	(*(volatile struct st_riic    __sfr __evenaccess *)0x88360)
...
#define	SMCI7	(*(volatile struct st_smci0   __sfr __evenaccess *)0x8A0E0)
...
#define	USB1	(*(volatile struct st_usb1    __sfr __evenaccess *)0xA0200)
#define	WDT		(*(volatile struct st_wdt     __sfr __evenaccess *)0x88020)
#define	FLASHCONST	(*(volatile struct st_flashconst     __sfr __evenaccess *)0xFEFFFAC0)
#define	TEMPSCONST	(*(volatile struct st_tempsconst     __sfr __evenaccess *)0xFEFFFAD2)
#ifdef __IAR_SYSTEMS_ICC__
