...
#if (BSP_CFG_CLOCK_SOURCE == 3) || (BSP_CFG_LPT_CLOCK_SOURCE == 0) || (BSP_CFG_LCD_CLOCK_SOURCE == 3)
...
static void clock_source_select (void)
{
...
#else /* (BSP_CFG_CLOCK_SOURCE != 1) && (BSP_CFG_LCD_CLOCK_SOURCE != 1) */
...
#if (BSP_CFG_CLOCK_SOURCE == 2) || (BSP_CFG_CLOCK_SOURCE == 4) || (BSP_CFG_LCD_CLOCK_SOURCE == 2) \
     || (BSP_CFG_USB_CLOCK_SOURCE == 1)
    ...
    while(0 == SYSTEM.OSCOVFSR.BIT.MOOVF)
    {
        ...
        R_BSP_NOP();
          ...
          (BSP_CFG_LCD_CLOCK_SOURCE == 2) || (BSP_CFG_USB_CLOCK_SOURCE == 1) */
...
static void usb_lcd_clock_source_select (void)
{
    ...
    */
    ...
    /* System clock is selected as UCLK.(defalt) */
    /* USB-dedicated PLL is stopped.(defalt) */
#endif
...
#if (BSP_CFG_LCD_CLOCK_SOURCE == 4) || (BSP_CFG_LPT_CLOCK_SOURCE == 1)
...
#if (BSP_CFG_LCD_CLOCK_SOURCE > 5) || (BSP_CFG_LCD_CLOCK_SOURCE < 0) || \
    ((BSP_CFG_LCD_CLOCK_ENABLE == 1) && (BSP_CFG_LCD_CLOCK_SOURCE == 5))
    ...
    */    
    ...
    /* Protect on. */
    SYSTEM.PRCR.WORD = 0xA500;
} /* End of function usb_lcd_clock_source_select() */
