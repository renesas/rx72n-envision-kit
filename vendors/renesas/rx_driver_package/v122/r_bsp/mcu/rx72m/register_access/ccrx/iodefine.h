...
#define	DSMIF	(*(volatile struct st_dsmif    __evenaccess *)0xA07E0)
#define	DSMIF0	(*(volatile struct st_dsmif0   __evenaccess *)0xA0700)
#define	DSMIF1	(*(volatile struct st_dsmif0   __evenaccess *)0xA0780)
...
#define	ESC		(*(volatile struct st_esc      __evenaccess *)0xE3600)
