...
*
* History    : V0.50A (2018-12-20)  [Hardware Manual Revision : 0.50]
*              V0.50B (2019-02-22)  [Hardware Manual Revision : 0.50]
*              V0.50C (2019-03-20)  [Hardware Manual Revision : 0.50]
*              V1.00  (2019-04-15)  [Hardware Manual Revision : 1.00]
*
...
/*                                                                              */
/********************************************************************************/
#ifndef __RX72MIODEFINE_HEADER__
#define __RX72MIODEFINE_HEADER__
...
#define	MSTP_DSMIF	SYSTEM.MSTPCRB.BIT.MSTPB11
#define	MSTP_DSMIF0	SYSTEM.MSTPCRB.BIT.MSTPB11
#define	MSTP_DSMIF1	SYSTEM.MSTPCRB.BIT.MSTPB11
...
#define	MSTP_ESC	SYSTEM.MSTPCRD.BIT.MSTPD11
...
#define	IS_DSMIF0_OCDI0		IS1
#define	IS_DSMIF0_SUMEI0	IS2
#define	IS_DSMIF0_SCDI0		IS3
#define	IS_DSMIF1_OCDI1		IS4
#define	IS_DSMIF1_SUMEI1	IS5
#define	IS_DSMIF1_SCDI1		IS6
...
#define	EN_DSMIF0_OCDI0		EN1
#define	EN_DSMIF0_SUMEI0	EN2
#define	EN_DSMIF0_SCDI0		EN3
#define	EN_DSMIF1_OCDI1		EN4
#define	EN_DSMIF1_SUMEI1	EN5
#define	EN_DSMIF1_SCDI1		EN6
...
#define	GEN_DSMIF0_OCDI0	GENBL2
#define	GEN_DSMIF0_SUMEI0	GENBL2
#define	GEN_DSMIF0_SCDI0	GENBL2
#define	GEN_DSMIF1_OCDI1	GENBL2
#define	GEN_DSMIF1_SUMEI1	GENBL2
#define	GEN_DSMIF1_SCDI1	GENBL2
...
#define	GRP_DSMIF0_OCDI0	GRPBL2
#define	GRP_DSMIF0_SUMEI0	GRPBL2
#define	GRP_DSMIF0_SCDI0	GRPBL2
#define	GRP_DSMIF1_OCDI1	GRPBL2
#define	GRP_DSMIF1_SUMEI1	GRPBL2
#define	GRP_DSMIF1_SCDI1	GRPBL2
...
#define	DSMIF	(*(volatile struct st_dsmif    __sfr __evenaccess *)0xA07E0)
#define	DSMIF0	(*(volatile struct st_dsmif0   __sfr __evenaccess *)0xA0700)
#define	DSMIF1	(*(volatile struct st_dsmif0   __sfr __evenaccess *)0xA0780)
...
#define	ESC		(*(volatile struct st_esc      __sfr __evenaccess *)0xE3600)
...
typedef struct st_dsmif {
	union {
		unsigned long LONG;
		struct {
			unsigned long :26;
			unsigned long EDGE5:1;
			unsigned long EDGE4:1;
			unsigned long EDGE3:1;
			unsigned long EDGE2:1;
			unsigned long EDGE1:1;
			unsigned long EDGE0:1;
		} BIT;
	} DSCCR;
	union {
		unsigned long LONG;
		struct {
			unsigned long :26;
			unsigned long DIS5:1;
			unsigned long DIS4:1;
			unsigned long DIS3:1;
			unsigned long DIS2:1;
			unsigned long DIS1:1;
			unsigned long DIS0:1;
		} BIT;
	} DSCHR;
} st_dsmif_t;

typedef struct st_dsmif0 {
	union {
		unsigned long LONG;
		struct {
			unsigned long OCSH:4;
			unsigned long :1;
			unsigned long OCDEC:3;
			unsigned long :2;
			unsigned long OCSINC:2;
			unsigned long CMSH:4;
			unsigned long :1;
			unsigned long CMDEC:3;
			unsigned long :2;
			unsigned long CMSINC:2;
			unsigned long CKDIV:4;
			unsigned long :2;
			unsigned long CKDIR:1;
			unsigned long FEN:1;
		} BIT;
	} DSCR;
	union {
		...
		struct {
			unsigned long :23;
			unsigned long SUMERR:1;
			unsigned long :1;
			unsigned long SCF2:1;
			unsigned long SCF1:1;
			unsigned long SCF0:1;
			unsigned long :1;
			unsigned long OCF2:1;
			unsigned long OCF1:1;
			unsigned long OCF0:1;
		} BIT;
	} DSSR;
	unsigned long  OCLTR;
	unsigned long  OCHTR;
	unsigned long  SCLTR;
	unsigned long  SCHTR;
	unsigned long  SUMLTR;
	unsigned long  SUMHTR;
	unsigned long  CDR0;
	unsigned long  CCDR0;
	unsigned long  TCDR0;
	unsigned long  OCDR0;
...
typedef struct st_esc {
	union {
		unsigned long LONG;
		struct {
			unsigned long :30;
			unsigned long PHYRST:1;
			unsigned long ESCRST:1;
		} BIT;
	} ESCRST;
	char           wk0[12];
	union {
		...
		struct {
			unsigned long :30;
			unsigned long LINKPOL1:1;
			unsigned long LINKPOL0:1;
		} BIT;
	} PHYLINK;
	union {
		unsigned long LONG;
		struct {
			unsigned long :29;
			unsigned long ESCIC:1;
			unsigned long SYNC1C:1;
			unsigned long SYNC0C:1;
		} BIT;
	} ESCICR;
	union {
		unsigned long LONG;
	...
	union {
		...
		struct {
			unsigned long :28;
			unsigned long TXSFT1:2;
			unsigned long TXSFT0:2;
		} BIT;
	} TXSFTR;
	char           wk1[18908];
	unsigned char  TYPE;
	...
	char           wk2[6];
	unsigned short STATIONADR;
	unsigned short STATIONALIAS;
	char           wk3[12];
	union {
		unsigned char BYTE;
		struct {
	...
	union {
		...
		struct {
			unsigned short :14;
			unsigned short DATABUSWID:2;
		} BIT;
	} EXTPDICONFIG;
	char           wk15[172];
	unsigned short ECATEVENTMASK;
	char           wk16[2];
	unsigned long  ALEVENTMASK;
	char           wk17[8];
	union {
		unsigned short WORD;
		struct {
	...
	union {
		unsigned short WORD;
		struct {
			unsigned short RXERRCNT:8;
			unsigned short INVFRMCNT:8;
		} BIT;
	} RXERRCOUNT0;
	union {
		unsigned short WORD;
	...
	char           wk20[4];
	unsigned char  FWDRXERRCOUNT0;
	unsigned char  FWDRXERRCOUNT1;
	char           wk21[2];
	unsigned char  EPUERRCOUNT;
	unsigned char  PDIERRCOUNT;
	char           wk22[2];
	unsigned char  LOSTLINKCOUNT0;
	unsigned char  LOSTLINKCOUNT1;
	char           wk23[238];
	unsigned short WDDIVIDE;
	char           wk24[14];
	unsigned short WDTPDI;
	char           wk25[14];
	unsigned short WDTDATA;
	char           wk26[30];
	union {
		unsigned short WORD;
		struct {
	...
	unsigned char  WDCDATA;
	unsigned char  WDCPDI;
	char           wk27[188];
	union {
		unsigned char BYTE;
		struct {
	...
	char           wk29[232];
	unsigned long  FMMU0LSTARTADR;
	unsigned short FMMU0LEN;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :5;
	...
	union {
		...
		struct {
			unsigned char :5;
			unsigned char LSTPBIT:3;
		} BIT;
	} FMMU0LSTOPBIT;
	unsigned short FMMU0PSTARTADR;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :5;
	...
	char           wk30[3];
	unsigned long  FMMU1LSTARTADR;
	unsigned short FMMU1LEN;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :5;
	...
	char           wk31[3];
	unsigned long  FMMU2LSTARTADR;
	unsigned short FMMU2LEN;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :5;
	...
	char           wk32[3];
	unsigned long  FMMU3LSTARTADR;
	unsigned short FMMU3LEN;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :5;
	...
	char           wk33[3];
	unsigned long  FMMU4LSTARTADR;
	unsigned short FMMU4LEN;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :5;
	...
	char           wk34[3];
	unsigned long  FMMU5LSTARTADR;
	unsigned short FMMU5LEN;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :5;
	...
	char           wk35[3];
	unsigned long  FMMU6LSTARTADR;
	unsigned short FMMU6LEN;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :5;
	...
	char           wk36[3];
	unsigned long  FMMU7LSTARTADR;
	unsigned short FMMU7LEN;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :5;
	...
	char           wk37[387];
	unsigned short SM0PSTARTADR;
	unsigned short SM0LEN;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :1;
	...
	unsigned short SM1PSTARTADR;
	unsigned short SM1LEN;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :1;
	...
	unsigned short SM2PSTARTADR;
	unsigned short SM2LEN;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :1;
	...
	unsigned short SM3PSTARTADR;
	unsigned short SM3LEN;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :1;
	...
	unsigned short SM4PSTARTADR;
	unsigned short SM4LEN;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :1;
	...
	unsigned short SM5PSTARTADR;
	unsigned short SM5LEN;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :1;
	...
	unsigned short SM6PSTARTADR;
	unsigned short SM6LEN;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :1;
	...
	unsigned short SM7PSTARTADR;
	unsigned short SM7LEN;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :1;
	...
	char           wk38[192];
	unsigned long  DCRCVTIMEPORT0;
	unsigned long  DCRCVTIMEPORT1;
	char           wk39[8];
	unsigned long long DCSYSTIME;
	unsigned long long DCRCVTIMEEPU;
	unsigned long long DCSYSTIMEOFFSET;
	unsigned long  DCSYSTIMEDELAY;
	union {
		unsigned long LONG;
		struct {
	...
	union {
		...
		struct {
			unsigned short :1;
			unsigned short SCSTART:15;
		} BIT;
	} DCSCSTART;
	unsigned short DCSCDIFF;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :4;
			unsigned char FILDP:4;
		} BIT;
	} DCSYSTIMEFILDP;
	union {
		unsigned char BYTE;
	...
	unsigned long long DCCYCSTARTTIME;
	unsigned long long DCNEXTSYNC1;
	unsigned long  DCSYNC0CYCTIME;
	unsigned long  DCSYNC1CYCTIME;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :6;
	...
	unsigned long long DCLATCH0TIMEPOS;
	unsigned long long DCLATCH0TIMENEG;
	unsigned long long DCLATCH1TIMEPOS;
	unsigned long long DCLATCH1TIMENEG;
	char           wk43[32];
	unsigned long  DCECATCHGTIME;
	char           wk44[4];
	unsigned long  DCPDISTARTTIME;
	unsigned long  DCPDICHGTIME;
	char           wk45[1024];
	...
	union {
		...
		unsigned short WDATA[64];
		unsigned char BDATA[128];
	} USERRAM;
	union {
		unsigned long LDATA[2048];
		unsigned short WDATA[4096];
