...
#define	DSMIF	(*(volatile struct st_dsmif     *)0xA07E0)
#define	DSMIF0	(*(volatile struct st_dsmif0    *)0xA0700)
#define	DSMIF1	(*(volatile struct st_dsmif0    *)0xA0780)
...
#define	ESC		(*(volatile struct st_esc       *)0xE3600)
