...
/* NOTE:
   The default settings are the same as when using RSKRX110.
...
/* Clock configuration options.
   ...
   ICLK is 16MHz, PCLKB is 16MHz, FCLK is 16MHz, PCLKD is 16MHz, and CKO is 1MHz then the 
   settings would be:

   BSP_CFG_XTAL_HZ  = 16000000
   BSP_CFG_ICK_DIV  = 1      : System Clock (ICLK)        = 
                               (BSP_CFG_XTAL_HZ / BSP_CFG_ICK_DIV)  = 16MHz
   BSP_CFG_PCKB_DIV = 1      : Peripheral Clock B (PCLKB) = 
                               (BSP_CFG_XTAL_HZ / BSP_CFG_PCKB_DIV) = 16MHz
   BSP_CFG_PCKD_DIV = 1      : Peripheral Clock D (PCLKD) = 
                               (BSP_CFG_XTAL_HZ / BSP_CFG_PCKD_DIV) = 16MHz
   BSP_CFG_FCK_DIV  = 1      : Flash IF Clock (FCLK)      = 
                               (BSP_CFG_XTAL_HZ / BSP_CFG_FCK_DIV)  = 16MHz
*/
