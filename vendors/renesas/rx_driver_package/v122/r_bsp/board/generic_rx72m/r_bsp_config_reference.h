...
/* NOTE:
   The default settings are the same as when using RSKRX72M.
...
/* EtherCAT(ESC) clock source (EPLLSEL). Choose which clock source to input to the EtherCAT circuit.
   Available clock sources:
   0 = PCLKA
   1 = PPLLDIVCLK (default)
*/
#define BSP_CFG_ESC_CLOCK_SOURCE        (1)
