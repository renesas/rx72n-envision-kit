...
***********************************************************************************************************************/
  ...
  || defined(BSP_MCU_RX71M) || defined(BSP_MCU_RX72T) || defined(BSP_MCU_RX72M) || defined(BSP_MCU_RX72N))
                     ...
                     uint16_t * const   p_data)
{
  ...
  || defined(BSP_MCU_RX71M) || defined(BSP_MCU_RX72T) || defined(BSP_MCU_RX72M) || defined(BSP_MCU_RX72N))
    ...
    #if (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX65_ALL) || defined(BSP_MCU_RX71M) || defined(BSP_MCU_RX72M) || defined(BSP_MCU_RX72N))
    if (unit > 1)
    {
...
adc_err_t R_ADC_ReadAll(adc_data_t * const  p_all_data)
{
  ...
  || defined(BSP_MCU_RX130) || defined(BSP_MCU_RX72N))
