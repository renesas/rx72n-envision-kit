...
***********************************************************************************************************************/
#ifndef S12AD_RX23W_IF_H
#define S12AD_RX23W_IF_H
...
{
    adc_speed_t     conv_speed;      // ADCSR.ADHSC, rx23w has two conversion speeds
...
{
    uint32_t        chan_mask;          // channels/bits 0-7, 16-20, 27
...
typedef enum e_adc_reg
{
    ...
    ADC_REG_CH18,
    ADC_REG_CH19,
    ADC_REG_CH20,         // Channel 20
    ADC_REG_CH27,         // Channel 27
