...
***********************************************************************************************************************/
/**********************************************************************************************************************
* File Name    : r_s12ad_rx72m_if.h
* Description  : 12-bit A/D Converter driver interface file.
***********************************************************************************************************************
* History : DD.MM.YYYY Version Description
*           31.07.2019 1.00    Initial Release.
***********************************************************************************************************************/

#ifndef S12AD_RX72M_IF_H
#define S12AD_RX72M_IF_H
...
typedef enum e_adc_trig           // trigger sources (set to TRSA bit or TRSB bit)
{
    ...
    ADC_TRIG_SYNC_ELCTRG0                = 17,  // Activation source 0 from ELC (ELCTRG00N or ELCTRG10N)
    ADC_TRIG_SYNC_ELCTRG1                = 18,  // Activation source 1 from ELC (ELCTRG01N or ELCTRG11N)
    ADC_TRIG_SYNC_ELCTRG0_OR_ELCTRG1     = 25,  // Activation source 0 from ELC or Activation source 1 from ELC
