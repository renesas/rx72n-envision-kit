...
*
* Arguments    : unit -
*                    Ignored for rx230. Pass 0 for this argument.
*                mode -
...
* Description  : This is the RX230 implementation of R_ADC_Close().
...
* Description  : This is the RX230 implementation of R_ADC_ReadAll().
