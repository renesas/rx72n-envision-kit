...
* Description  : Functions for using SCI on the RX210 device.
***********************************************************************************************************************
...
R_BSP_PRAGMA_STATIC_INTERRUPT(sci2_eri2_isr, VECT(SCI2,ERI2))
R_BSP_ATTRIB_STATIC_INTERRUPT void sci2_eri2_isr(void);
...
R_BSP_PRAGMA_STATIC_INTERRUPT(sci3_eri3_isr, VECT(SCI3,ERI3))
R_BSP_ATTRIB_STATIC_INTERRUPT void sci3_eri3_isr(void);
...
R_BSP_PRAGMA_STATIC_INTERRUPT(sci4_eri4_isr, VECT(SCI4,ERI4))
R_BSP_ATTRIB_STATIC_INTERRUPT void sci4_eri4_isr(void);
...
R_BSP_PRAGMA_STATIC_INTERRUPT(sci7_eri7_isr, VECT(SCI7,ERI7))
R_BSP_ATTRIB_STATIC_INTERRUPT void sci7_eri7_isr(void);
...
R_BSP_PRAGMA_STATIC_INTERRUPT(sci10_eri10_isr, VECT(SCI10,ERI10))
R_BSP_ATTRIB_STATIC_INTERRUPT void sci10_eri10_isr(void);
